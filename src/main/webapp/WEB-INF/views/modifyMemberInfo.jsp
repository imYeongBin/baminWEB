...
<script src="${webRoot}/resources/js/modifyMemberInfo.js"></script>
<meta charset="UTF-8">
<title>Insert title here</title>
</head>
<body data-ng-app="myApp" data-ng-controller="comm"> 
	<form action="./modifyMemberInfo.do" name="regForm" method="post" accept-charset="utf-8">
	<h3> welcome modifyMemberInfo page!!</h3>
	<!-- input area -->
		<table>
			<tr>
				<th>이름</th>
